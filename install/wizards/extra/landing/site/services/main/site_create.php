...
$site_id = "";
if (COption::GetOptionString("main", "site_landing_create", "N") == "Y")
{
	$site_id = COption::GetOptionString("main", "site_landing_id"); 
	...
	if (!($db_res && $res = $db_res->Fetch()))
	{
		...
		$arFields = array(
			...
			"SORT" => 500,
			"DEF" => "N",
			"NAME" => GetMessage("wiz_site_landing_name"),
			"DIR" => COption::GetOptionString("main", "site_landing_folder"),
			"SITE_NAME" => GetMessage("wiz_site_landing_name"),
		...
		if ($result)
		{
			COption::SetOptionString("main", "site_landing_create", "N"); 
		}
		else 
		{
